<nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
    <div class="position-sticky pt-3">
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                <a class="nav-link {{ request()->routeIs('admin.users.list') ? 'active' : '' }}" href="{{ route('admin.users.list') }}">
                    <span data-feather="file"></span>
                    @lang('Users')
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ request()->routeIs('admin.products.list') ? 'active' : '' }}" href="{{ route('admin.products.list') }}">
